            ...
            <tr key={payment.id} class='table-row border-y-2'>
              ...
              <td class='table-cell py-3'>
                <button
                  ...
                  class='px-4 py-1 text-sm font-semibold rounded-full border  hover:text-white hover:bg-slate-400 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-offset-2'
                >
                  Copy
                </button>
              </td>
